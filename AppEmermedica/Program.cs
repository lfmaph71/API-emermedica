...
using (var scope = app.Services.CreateScope())
{
    ...
    dbContext.Database.Migrate(); // Aplica las migraciones autom�ticamente
}
...
app.UseMiddleware<AppEmermedica.Infraestructura.Middlewares.ExceptionHandlingMiddleware>();
